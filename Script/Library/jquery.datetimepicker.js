	...
	Array.prototype.indexOf || (Array.prototype.indexOf = function(e, t) {
	  ...
	  return this.each(function() {
		var a, n, r, o, s, i = e(this),
		  ...
		  g = 0,
		  p = function() {};
		return "hide" === t ? void i.find(".xdsoft_scrollbar").hide() : (e(this).hasClass("xdsoft_scroller_box") || (a = i.children().eq(0), n = i[0].clientHeight, r = a[0].offsetHeight, o = e('<div class="xdsoft_scrollbar"></div>'), s = e('<div class="xdsoft_scroller"></div>'), o.append(s), i.addClass("xdsoft_scroller_box").append(o), p = function(e) {
		  var t = u(e).y - c + g;
	  ...
	  return n = function(t) {
		...
		var r, O, _, F, A, Y, P = e('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
		...
		S.id && P.attr("id", S.id), S.style && P.attr("style", S.style), S.weeks && P.addClass("xdsoft_showweeks"), P.addClass("xdsoft_" + S.theme), P.addClass(S.className), J.find(".xdsoft_month span").after(L), J.find(".xdsoft_year span").after(B), J.find(".xdsoft_month,.xdsoft_year").on("mousedown.xdsoft", function(t) {
		  var a, n, r = e(this).find(".xdsoft_select").eq(0),
			...
			s = 0,
			i = r.is(":visible");
		  for (J.find(".xdsoft_select").hide(), Y.currentTime && (o = Y.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()), r[i ? "hide" : "show"](), a = r.find("div.xdsoft_option"), n = 0; n < a.length && a.eq(n).data("value") !== o; n += 1) s += a[0].offsetHeight;
		  ...
		  S = e.extend(!0, {}, S, a), a.allowTimes && e.isArray(a.allowTimes) && a.allowTimes.length && (S.allowTimes = e.extend(!0, [], a.allowTimes)), a.weekends && e.isArray(a.weekends) && a.weekends.length && (S.weekends = e.extend(!0, [], a.weekends)), a.highlightedDates && e.isArray(a.highlightedDates) && a.highlightedDates.length && (e.each(a.highlightedDates, function(t, a) {
			...
			for (var r, o, s, i = e.map(a.split(","), e.trim), u = Date.parseDate(i[0], S.formatDate), d = Date.parseDate(i[1], S.formatDate), l = i[2], c = i[3]; d >= u;) r = new HighlightedDate(u, l, c), o = u.dateFormat(S.formatDate), u.setDate(u.getDate() + 1), void 0 !== n[o] ? (s = n[o].desc, s && s.length && r.desc && r.desc.length && (n[o].desc = s + "\n" + r.desc)) : n[o] = r
			...
			var n, F, A = this.value,
			  Y = a.which;
			if (Y >= o && s >= Y || Y >= i && u >= Y || Y === m || Y === l) {
			  for (n = r(this), F = Y !== m && Y !== l ? String.fromCharCode(Y >= i && u >= Y ? Y - o : Y) : "_", Y !== m && Y !== l || !n || (n -= 1, F = "_");
				/[^0-9_]/.test(S.mask.substr(n, 1)) && n < S.mask.length && n > 0;) n += Y === m || Y === l ? -1 : 1;
			  if (A = A.substr(0, n) + F + A.substr(n + 1), "" === e.trim(A)) A = S.mask.replace(/[0-9]/g, "_");
			  else if (n === S.mask.length) return a.preventDefault(), !1;
			  for (n += Y === m || Y === l ? 0 : 1;
				/[^0-9_]/.test(S.mask.substr(n, 1)) && n < S.mask.length && n > 0;) n += Y === m || Y === l ? -1 : 1;
			...
			if (S.allowBlank && !e.trim(e(this).val()).length) e(this).val(null), P.data("xdsoft_datetime").empty();
			else if (Date.parseDate(e(this).val(), S.format)) P.data("xdsoft_datetime").setCurrentTime(e(this).val());
			else {
		  ...
		  N.xdsoftScroller()
		}), P.append(C).append(I), S.withoutCopyright !== !0 && P.append(W), C.append(J).append(H).append(j), e(S.parentID).append(P), r = function() {
		  var t = this;
		  t.now = function(e) {
			var a, n, r = new Date;
		  ...
		  clearTimeout(O), O = setTimeout(function() {
			...
			if (c += "</tbody></table>", H.html(c), J.find(".xdsoft_label span").eq(0).text(S.i18n[S.lang].months[Y.currentTime.getMonth()]), J.find(".xdsoft_label span").eq(1).text(Y.currentTime.getFullYear()), v = "", y = "", s = "", d = function(e, t) {
			  ...
			  for (m = 0; m < S.allowTimes.length; m += 1) y = Y.strtotime(S.allowTimes[m]).getHours(), s = Y.strtotime(S.allowTimes[m]).getMinutes(), d(y, s);
			else
			  for (m = 0, t = 0; m < (S.hours12 ? 12 : 24); m += 1)
				for (t = 0; 60 > t; t += S.step) y = (10 > m ? "0" : "") + m, s = (10 > t ? "0" : "") + t, d(y, s);
			for (z.html(v), a = "", m = 0, m = parseInt(S.yearStart, 10) + S.yearOffset; m <= parseInt(S.yearEnd, 10) + S.yearOffset; m += 1) a += '<div class="xdsoft_option ' + (Y.currentTime.getFullYear() === m ? "xdsoft_current" : "") + '" data-value="' + m + '">' + m + "</div>";
			for (B.children().eq(0).html(a), m = parseInt(S.monthStart, 10), a = ""; m <= parseInt(S.monthEnd, 10); m += 1) a += '<div class="xdsoft_option ' + (Y.currentTime.getMonth() === m ? "xdsoft_current" : "") + '" data-value="' + m + '">' + S.i18n[S.lang].months[m] + "</div>";
	  ...
	  var l = e.event.special.mousewheel = {
		...
		setup: function() {
		  if (this.addEventListener)
			for (var a = i.length; a;) this.addEventListener(i[--a], t, !1);
		  else this.onmousewheel = t;
		  e.data(this, "mousewheel-line-height", l.getLineHeight(this)), e.data(this, "mousewheel-page-height", l.getPageHeight(this))
		},
		teardown: function() {
		  if (this.removeEventListener)
			for (var a = i.length; a;) this.removeEventListener(i[--a], t, !1);
